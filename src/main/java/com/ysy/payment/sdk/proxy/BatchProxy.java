...
public class BatchProxy {
	...
	private static final String bat_proxy_url = "http://cp.esyto.com:9000/gateway/api/batchProxyReq";
	
	static Logger log = LoggerFactory.getLogger(BatchProxy.class);
	
	public static void main(String[] args) throws Exception {
		String paydetail_1="wnf-trans-953882466286829005^批量代付1^6214856555342173^曾云龙^0.02^个人^储蓄卡^招商银行^^^^^测试代付^ ";
		String paydetail_2="wnf-trans-953882466286829006^批量代付2^6214856555342173^曾云龙^0.02^个人^储蓄卡^招商银行^^^^^测试代付^ ";
		...
		batchDto.setBatchamount("0.04");
		batchDto.setBatchnum("2");
		batchDto.setPaydate(new SimpleDateFormat("yyyyMMdd").format(new Date()));
		batchDto.setPaydetail(paydetail);
		batchDto.setBackurl("");
		System.out.println(batchDto.toString());
		...
		String result = HttpsClientUtil.sendRequest(bat_proxy_url, postStr, "application/json");
